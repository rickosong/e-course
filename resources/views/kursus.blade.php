                                ...
                                <div class="bg-gray-100 p-4 rounded-lg flex">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex space-x-2 pt-4">
                                            ...
                                            <button id="dataId" data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="bg-red-500 hover:bg-red-600 text-white text-sm py-2 px-4 rounded" value="{{$course->id}}">Hapus</button>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
