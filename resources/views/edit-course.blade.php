        ...
        <form action="{{ route('kursus.update', $course->id) }}" method="post" class="p-4 md:p-5" enctype="multipart/form-data">
            ...
            <div class="grid gap-4 mb-4 grid-cols-2">
                ...
                <div class="col-span-2">
                    ...
                    <input type="text" name="judul" id="name" value="{{ $course->judul }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Judul" required="">
                </div>

                <!-- Deskripsi -->
                <div class="col-span-2">
                    <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deskripsi</label>
                    <textarea id="description" name="deskripsi" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Deskripsi">{{ $course->deskripsi }}</textarea>
                </div>

                <!-- Link Video Embed -->
                <div class="col-span-2">
                    <label for="durasi" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Durasi (menit)</label>
                    <input type="text" name="durasi" id="durasi" value="{{ $course->durasi }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="durasi dalam menit" required="">
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <img src="{{ asset('img/'.$course->image) }}" alt="{{ $course->image }}" class="w-50 h-32 object-cover">
                </div>
            </div>
